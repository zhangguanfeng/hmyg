  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          transferTypeId: [
            { required: false, message: '请选择商户类型', trigger: 'change' }
          ],
          appid: [
          ...
          appProp: [
            { required: false, message: '请输入应用属性介绍', trigger: 'blur' }
          ],
          appPropEn: [
            { required: false, message: '请输入应用属性英文介绍', trigger: 'blur' }
          ],
          appIcon: [
            { required: true, message: '请输入应用图标地址', trigger: 'blur' }
          ],
          phone: [
            { required: false, message: '请输入商户手机号', trigger: 'blur' }
          ],
          destext: [
    ...
    activated() {
      ...
      this.server_path = /\/$/.test(SERVER_PATH) ? SERVER_PATH : SERVER_PATH + '/';
      this.resetForm();

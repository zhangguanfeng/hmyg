...
<template>
  <div class='currency-set'>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="190px">
      ...
      <el-form-item label="未身份认证每日转账限额:" prop="tranLimitNrealName">
        <el-input style="width:80%" v-model="ruleForm.tranLimitNrealName" size="small"
    ...
    data() {
      ...
      return {
        ruleForm: {
          ...
          //tranLimitNRealNameAmount: '',
          tranLimitNrealName:'',//tranLimitNRealNameAmount替代名
          auditInMinAmount: "",
          auditOutMinAmount: "",
          smsCkInMinAmount: "",
          smsCkOutMinAmount: "",
      ...
      onSubmit() {
        this.$refs.ruleForm.validate((valid) => {
          if (valid) {
            ...
            ruleForm.tranLimitNRealNameAmount=ruleForm.tranLimitNrealName
            ...
            if (ruleForm.coinId) {
              ...
              this.$http.post("wallet/backmgr/coin/updateCoinInfo.do", ruleForm).then((res) => {
                ...
                setTimeout(() => {
                  const path = this.$route.params.backPath || '/configurable/currency'
                  this.$router.push({
                    path: path,
                  })
                }, 1000)
    ...
    activated() {
      ...
      if (this.$route.params.coinId) {
        ...
        if (this.$route.params.coinName) {
          this.ruleForm.coinName = this.$route.params.coinName.trim()
        }
      }
    }
  };

...
export const appRouter = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/pages/brush-list/log.vue'),
      },
      {
        path: 'ruleSetting',
        name: 'ruleSetting',
...

  {
    ...
    children: [
      {
        path: 'coin',
        name: 'convertableCoin',
        meta: {
          title: '闪兑',
        },
        component: () => import('@/pages/convertable/coin.vue'),
      },
    ],
  },
  {
    path: '/agentControl',
    name: 'agentControl',
    redirect: '/agentControl/agentUser',
    meta: {
      title: '代理管理',
    },
    component: Index,
    children: [
      {
        ...
        component: () => import('@/pages/agent-control/user.vue'),
      },
      {
        path: 'agentRuleSetting',
        name: 'agentRuleSetting',
        meta: {
          title: '返佣规则设置',
        },
        component: () => import('@/pages/agent-control/ruleSetting.vue'),
      },
      {
        path: 'agentAccount',
        name: 'agentAccount',
        ...
        component: () => import('@/pages/agent-control/account.vue'),
      },
      {
        path: 'agentRecordList',
        name: 'agentRecordList',
        meta: {
          title: '返佣记录',
        },
        component: () => import('@/pages/agent-control/record-list.vue'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('@/pages/EUSC/eusc-user.vue'),
      },
      {
        path: 'purchase',
        name: 'purchase',
        ...
        component: () => import('@/pages/EUSC/purchase.vue'),
      },
      {
        path: 'euscRule',
        name: 'euscRule',
        ...
        component: () => import('@/pages/EUSC/eusc-rule.vue'),
      },
      {
        path: 'euscAudit',
        name: 'euscAudit',
        ...
        component: () => import('@/pages/EUSC/eusc-audit.vue'),
      },
      {
        path: 'euscRecord',
        name: 'euscRecord',
        ...
        component: () => import('@/pages/EUSC/eusc-record.vue'),
      },
      {
        path: 'euscearnings',
        name: 'euscearnings',
        ...
        component: () => import('@/pages/EUSC/euscearnings.vue'),
      },
      {
        path: 'euscRransfer',
        name: 'euscRransfer',
        ...
        component: () => import('@/pages/EUSC/transfer.vue'),
      },
    ],
  }
];

    ...
    <ul ref="data">
      ...
      <li v-loading="loading">
        ...
        <div class="text">
          ...
          <div>
            带宽数量：{{poolData.usdt_unlock.toFixed(2)}}
            <!-- 带宽数量：{{(+data.usdt_lock + +data.usdt_success).toFixed(2)}} -->
          </div>
          <div>
            能量数量：{{poolData.salpt_unlock.toFixed(2)}}
      ...
      <li v-loading="loading">
        ...
        <div class="text">
          ...
          <div>
            带宽数量：{{poolData.usdt_success.toFixed(2)}}
          </div>
          <div>
            能量数量：{{poolData.salpt_success.toFixed(2)}}
          </div>
        </div>
      </li>
      <li v-loading="loading">
        ...
        <div class="text">
          ...
          <div>
            带宽数量：{{poolData.usdt_lock.toFixed(2)}}
          </div>
          <div>
            能量数量：{{poolData.salpt_lock.toFixed(2)}}
          </div>
        </div>
      </li>
      <li v-loading="loading">
        ...
        <div class="text">
          ...
          <div>
            带宽累计：{{poolData.usdt_all.toFixed(2)}}
          </div>
          <div>
            能量累计：{{poolData.salpt_all.toFixed(2)}}
          </div>
        </div>
      </li>
    </ul>

  ...
  <div class='api-setting'>
    ...
    <el-form ref="form" :model="formData" label-width="100px" label-position="left">
			<el-form-item label="商户号：">
				<el-input v-model="formData.MERCHANT_NO" :disabled="true"></el-input>
			</el-form-item>
  ...
  export default {
    ...
    methods: {
      getData() {
        ...
        p.then(res => {
          let {MERCHANT_NO,USER_MOBILE,MERCHANT_SECRET,MERCHANT_CALLBACK_SECRET,MERCHANT_RETURN_URL} = res.result

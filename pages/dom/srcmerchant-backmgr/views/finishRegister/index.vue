  ...
  <div class="finishRegister">
      ...
      <div class="registerBox">
        ...
        <div class="register-form">
          ...
          <div class="address item">
            <span>所&nbsp;&nbsp;在&nbsp;&nbsp;地</span>
            <VDistpicker @province="choosePro" @city="chooseCity" @area="chooseArea" @selected="chooseAddress"></VDistpicker>
          </div>
          ...
          <div class="companyAddress item">
            <span>公司网址</span>
            <input type="text" placeholder="请输入贵公司网址" v-model="website">
          </div>
    ...
    <div class="popWin" v-show="showPop">
      <div class="popBox">
        ...
        <button class="popBtn" @click='hiddlenBox'>关闭</button>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      submit() {
        if(!this.name  || !this.mobilePhone || !this.password || !this.confirmPsd) {
        ...
        let p = this.$http.post('ajax_login/information',{
          ...
          merchant_company_website:this.website,
          merchant_location:`${this.province}_${this.city}_${this.area}`
        })
        p.then(res => {
          this.showPop = true
      ...
      getRegister() {
        this.$http.post('/ajax_login/register', {
          ...
          const {user_mobile, user_name} = res.result;
    ...
    mounted() {
      this.mobilePhone = sessionStorage.getItem('phone2')

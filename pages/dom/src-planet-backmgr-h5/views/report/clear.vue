<template>
  <div class="clear-wrap" :style="{height: height - 50 + 'px'}">
    <van-tabs v-model="currency">
      <van-tab title="提取理财包" name="USDT"></van-tab>
      <van-tab title="提取收益" name="SALPT"></van-tab>
    </van-tabs>
    <div class="filter">
      <div class="form-item">
      ...
      <div class="form-item">
        <img src="/img/search.png"  alt="">
          <van-field :disabled="true" @click.native.stop="showSelect('status')" :border="true" v-model="statusText" placeholder="请选择状态">
        </van-field>
      </div>
      <!-- <div class="form-item">
        <img src="/img/search.png"  alt="">
    ...
    <div class="table">
      <vxe-table
        ...
        <vxe-table-column title="提取时间" field="CREATED_AT" width="180"></vxe-table-column>
        <vxe-table-column title="提取类型" field="CURRENCY" width="100"></vxe-table-column>
        <vxe-table-column title="提取数量" field="USDT_NUMBER" width="100"></vxe-table-column>
        ...
        <vxe-table-column title="手续费" field="HANDING_FEE" width="100"></vxe-table-column>
         <vxe-table-column title="到账数量" field="AMOUNT_RECEIVE" width="100"></vxe-table-column>
      </vxe-table>
    </div>
    <van-pagination
      v-model="page"

    ...
    <div class="innerBox">
      <div class="title">
        ...
        <div class="title-text">
          <p class="title-text-top">Alphapay代理商管理系统登录平台</p>
          <p class="title-text-bottom">Alphapay Agent Center Management System Login Platform</p>
        </div>
      </div>
      <div class="loginBox">
        <div class="layer"></div>
...
export default {
  ...
  data() {
    return {
      ...
      googleError: false,
      showPopBox: true,
      email: "flashexchange@outlook.com",
      loginToken: "",
      btnDisabled: false,
      areaData: [],
      value: "+86",
